 ...
 * */
class ControllerProductCategoryCustomizePriceFilter extends Controller {
...
//var_dump($results);
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/category_customizepricefilter.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/category_customizepricefilter.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/product/category_customizepricefilter.tpl', $data));
			}
		} 
	}
}
