...
<div class="box">
		<div class="box-heading" style="color:hsl(0, 0%, 33%)"><?php echo $text_filter_price; ?><span <?php if(!$customizepricefilter_reset_button) echo"style='float:right;display:none;'"; else echo"style='float:right;display:block;'"; ?> onclick=resetslider();><button class="btn btn-primary" >Reset</button></span></div>
	        <div class="box-content" style='padding:40px 4px 40px 4px;width:auto;height:auto;'>
